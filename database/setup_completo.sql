...
-- Remover admin padrão se existir
DELETE FROM usuarios WHERE email = 'admin@portalnoticias.com' OR tipo_usuario = 'admin';

-- Inserir novo usuário administrador
INSERT INTO usuarios (nome, email, senha, tipo_usuario, ativo, email_verificado) VALUES 
('Administrador', 'admin@portalnoticias.com', '$2y$10$cbl5NCxXNpAemOaXSU..ZuRB1G558hlGocbIX2Cg2ZIpL4a6chYCm', 'admin', TRUE, TRUE);
